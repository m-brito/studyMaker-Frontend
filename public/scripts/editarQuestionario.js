            ...
            let cartaoQuestionario = `
                <div class="mostraPergunta">
                    ...
                    <div class="opcoesMostrarPerguntas">
                        <div class="meusquestionariosPerguntaEditar" onclick="editarPergunta(${respQuestionario["resultados"][0]["perguntas"][x]["id"]}, ${x+1})">
                            <img src="../../public/assets/Imagens/Icone-editar-branco.svg" alt="Editar">
                        </div>
                        <div class="meusquestionariosPerguntaDeletar" onclick="deletarPergunta(${respQuestionario["resultados"][0]["perguntas"][x]["id"]})">
...
async function deletarPergunta(idPergunta) {
    Confirm.open({
